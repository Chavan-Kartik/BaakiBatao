...
/**
 * Recharts v3 no longer declares `payload`/`label` on the prop types the
 * tooltip and legend content renderers receive (v2 did), so the shapes they
 * actually read are restated here rather than left as implicit `any`.
 */
